...
namespace APIVerve
{
    public class TextReadabilityScoreAPIClient
    {
        ...
        public TextReadabilityScoreAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public TextReadabilityScoreAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
